...
public interface Analysis extends Switch
{
    ...
    void caseAExpOp1FatExp(AExpOp1FatExp node);
    void caseAFatExp(AFatExp node);
    void caseAFatOp2TerFator(AFatOp2TerFator node);
    void caseATerFator(ATerFator node);
    void caseALExpRTermo(ALExpRTermo node);
    void caseAVariValTermo(AVariValTermo node);
    void caseAMinusExpTermo(AMinusExpTermo node);
