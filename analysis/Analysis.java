...
public interface Analysis extends Switch
{
    ...
    void caseAValueVarValueExp(AValueVarValueExp node);
    void caseAVariableVarValueExp(AVariableVarValueExp node);
    void caseAExplogVarValueExp(AExplogVarValueExp node);
    void caseAVariValExpExp(AVariValExpExp node);
