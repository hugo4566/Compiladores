...
public final class AExpGeqExpExpLogica extends PExpLogica
{
    private PExp _pre_;
    private TGreaterEq _greaterEq_;
    private PVarValueExp _varValueExp_;

    public AExpGeqExpExpLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpGeqExpExpLogica(
    ...
    {
        ((Analysis) sw).caseAExpGeqExpExpLogica(this);
    }
